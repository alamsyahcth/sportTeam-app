    ...
    return (
      <Animated.View style={styles.root}>
        <Animated.View style={[styles.headerTop, { transform: [{ translateY: translateDiffScroll }] }]}>
          <LinearGradient colors={['#FAFAF8', '#F4D375']} style={{ flex: 1 }} style={styles.head}>
        ...
        <Animated.ScrollView style={styles.body}>
          <View style={styles.section}>
            <Text style={{ color: '#7BB2D4', fontSize: 35, fontWeight: 'bold', marginVertical: 30 }}>
              Today Training Schedule
            </Text>
